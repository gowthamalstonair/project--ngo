...
export function DonatePage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.donationFrequency.trim()) {
      newErrors.donationFrequency = 'Donation Frequency is required';
    }
  ...
  const handleNext = async () => {
    if (validateForm()) {
      if (formData.donationType === 'things') {
  ...
  const generateReceipt = () => {
    const receiptData = {
      ...
      amount: formData.donationType === 'money' ? formData.amount : 'N/A',
      things: formData.donationType === 'things' ? formData.things : 'N/A',
    ...
    try {
      ...
      const emailContent = {
              ...
              <div style="padding: 30px 20px; background: #ffffff;">
                ...
                <div style="background: #f9fafb; padding: 25px; border-radius: 12px; margin: 25px 0; border-left: 5px solid #f97316;">
                  ...
                  <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">Mobile:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.mobile}</td></tr>
                    ...
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">Country:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.country}</td></tr>
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">City:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.city}</td></tr>
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">State:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.state}</td></tr>
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">Pincode:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.pincode}</td></tr>
                    ...
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">Donation Type:</td><td style="padding: 8px 0; color: #374151; font-weight: bold; text-transform: capitalize;">${receiptData.donationType}</td></tr>
                    <tr><td style="padding: 8px 0; color: #6b7280; font-weight: 500;">Frequency:</td><td style="padding: 8px 0; color: #374151; font-weight: bold;">${receiptData.donationFrequency === 'once' ? 'Give Once' : 'Give Monthly'}</td></tr>
                    ...
                    ${receiptData.donationType === 'money' ? 
        ...
        text: `
          ...
          Donation Type: ${receiptData.donationType}
          Frequency: ${receiptData.donationFrequency === 'once' ? 'Give Once' : 'Give Monthly'}
          ...
          Contact us: info@ngoindia.org | +91 11 4567 8900
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Your generous donation {formData.donationType === 'money' ? `of ₹${formData.amount}` : 'of items'} has been received successfully.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-xl mb-8">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formData.donationFrequency === 'once' ? 'Give Once' : 'Give Monthly'}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg border transition-colors ${
                        errors.state ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500'
                      } focus:ring-2 focus:border-transparent`}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      type="button"
                      onClick={() => {
                        handleInputChange('donationType', 'money');
                        handleInputChange('category', 'money');
                      }}
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        handleInputChange('donationType', 'things');
                        handleInputChange('category', 'things');
                      }}
                      className={`p-4 rounded-lg border-2 transition-colors text-center ${
                  ...
                  {errors.donationType && <p className="text-red-600 text-sm mt-1">{errors.donationType}</p>}
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      type="button"
                      onClick={() => handleInputChange('donationFrequency', 'once')}
                      className={`p-4 rounded-lg border-2 transition-colors text-center ${
                        formData.donationFrequency === 'once'
                          ? 'border-orange-500 bg-orange-50 text-orange-600'
                          : 'border-gray-200 hover:border-gray-300'
                      }`}
                    >
                      <Calendar className="w-6 h-6 mx-auto mb-2" />
                      <span className="font-medium">Give Once</span>
                    </button>
                    <button
                      type="button"
                      onClick={() => handleInputChange('donationFrequency', 'monthly')}
                      className={`p-4 rounded-lg border-2 transition-colors text-center ${
                    ...
                    >
                      ...
                      <span className="font-medium">Give Monthly</span>
                    </button>
                  </div>
                  {errors.donationFrequency && <p className="text-red-600 text-sm mt-1">{errors.donationFrequency}</p>}
                </div>
                ...
                >
                  {isProcessing && formData.donationType === 'things' ? 'Processing Donation...' : 
                   formData.donationType === 'money' ? 'Continue to Payment' : 'Submit Donation'}
                </button>
              </div>
            </div>
          )}
            ...
            <div className="p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-xl mb-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">State:</span>
                    <span className="font-medium text-gray-900">{formData.state}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Pincode:</span>
                    <span className="font-medium text-gray-900">{formData.pincode}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Purpose:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Frequency:</span>
                    <span className="font-medium text-gray-900 capitalize">{formData.donationFrequency === 'once' ? 'Give Once' : 'Give Monthly'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Donor Type:</span>
                  ...
                  {formData.donationType === 'money' ? (
                    ...
                    <div className="border-t border-gray-200 pt-3">
                      ...
                      <p className="text-gray-900 mt-1">{formData.things}</p>
                      {formData.thingsFiles.length > 0 && (
                        <div className="mt-2">
                          <span className="text-gray-600">Attached Files:</span>
                          <div className="mt-1">
                            {formData.thingsFiles.map((file, index) => (
                              <span key={index} className="inline-block bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded mr-2 mb-1">
                                {file.name}
                              </span>
                            ))}
                          </div>
              ...
              <button
                ...
                className="w-full bg-orange-500 text-white py-4 rounded-lg font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-lg"
              >
                {isProcessing ? (formData.donationType === 'money' ? 'Processing Payment...' : 'Processing Donation...') : (formData.donationType === 'money' ? `Donate ₹${formData.amount}` : 'Submit Donation')}
              </button>
            </div>
          )}
        </div>
